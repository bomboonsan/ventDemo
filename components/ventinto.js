...
export default function VentInto() {
    ...
    let listInstructionText = [      
        ...
        'Expiratory Sensitivity คือระดับความไวในการหายใจออก โดยเป็นการกำหนด % ของ Peak Inspiration Flow ใน Pressure Support Mode หากผู้ป่วยมี Flow ที่ลดลงจนถึงค่า % ที่ตั้งไว้ เครื่องจะหยุดการจ่ายอากาศ แล้วเปลี่ยนเป็นช่วงหายใจออก',
        ...
        'Square Flow Pattern คือรูปแบบของการจ่ายอากาศใน Volume Control Mode โดยมีอัตราการไหลของอากาศคงที่ตลอดในช่วงระยะเวลาหายใจเข้า',
